...
- Dynamic-camera reconstruction requires camera-trajectory conditioning in addition to a pose prior; [[AnyLift: Scaling Motion Reconstruction from Internet Videos via 2D Diffusion]] combines both with Internet-video 2D keypoints.
