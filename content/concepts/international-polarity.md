...
International polarity describes the distribution of capabilities among major centers of power. Unipolarity denotes one predominant power, bipolarity two dominant powers, and multipolarity multiple influential poles. Classifications depend on which capabilities, actors, geographic scale, and thresholds an analysis uses.

## Key Ideas

- Polarity describes a structure; multipolarism is a policy orientation favoring the creation or promotion of multiple power centers.
